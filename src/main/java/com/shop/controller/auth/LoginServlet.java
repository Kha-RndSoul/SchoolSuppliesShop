...
public class LoginServlet extends HttpServlet {
    ...
    public void init() {
        ...
        try {
            ...
            System.out.println(" CartService created successfully");
            ...
            if (isEmail) {
                ...
                try {
                    ...
                    if (customer != null) {
                        ...
                        try {
                            int cartCount = cartService.getCartCount(customer.getId());
                            session.setAttribute("cartCount", cartCount);
                            System.out.println(" Cart count loaded: " + cartCount);
                        } catch (Exception ex) {
                            System.err.println(" Failed to load cart count: " + ex.getMessage());
