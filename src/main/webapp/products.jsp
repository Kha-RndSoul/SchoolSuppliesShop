...
<header class="header">
    <nav class="navbar">
        ...
        <form action="${pageContext.request.contextPath}/products" method="GET" class="search-bar">
            <input type="text" name="keyword" value="${searchKeyword}" placeholder="Tìm kiếm sản phẩm...">
                ...
                <c:forEach var="category" items="${allCategories}">
                    <li>
                        <a href="${pageContext.request.contextPath}/products?categoryId=${category.id}"
                           class="${currentCategory != null && currentCategory.id == category.id ? 'active' :  ''}">
                        ...
                        <div class="product-info">
                            ...
                            <div>
                                ...
                                <c:when test="${not empty product.sale_price && product.sale_price > 0}">
                                    <span class="product-price"><fmt:formatNumber value="${product.sale_price}" pattern="#,###"/>đ</span>
