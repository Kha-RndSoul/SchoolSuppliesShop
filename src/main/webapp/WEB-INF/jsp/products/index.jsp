            ...
            <div class="categories-grid">
                <c:forEach var="category" items="${featuredCategories}">
                    <a href="${pageContext.request.contextPath}/products?categoryId=${category.id}" class="category-card">
                        <img src="${pageContext.request.contextPath}${category.imageUrl}" alt="${category.categoryName}" class="category-image" onerror="this.src='${pageContext.request.contextPath}/assets/images/no-image.png'">
            ...
            <div class="products-grid">
                <c:forEach var="product" items="${bestSellingProducts}">
                    <a href="${pageContext.request.contextPath}/product-detail?id=${product.id}" class="product-card">
                        ...
                        <img src="${pageContext.request.contextPath}${product.imageUrl}" alt="${product.productName}" class="product-image" onerror="this.src='${pageContext.request.contextPath}/assets/images/no-image.png'">
                ...
                <c:forEach var="coupon" items="${topCoupons}">
                    <div class="category-card">
                        <div class="promo-visual">
                            <img class="promo-icon" src="${pageContext.request.contextPath}/assets/images/icons/coupon-icon.png" onerror="this.src='${pageContext.request.contextPath}/assets/images/no-image.png'">
                        </div>
                        <div class="category-info">
                            <h3>${coupon.code}</h3>
