...
<%--@elvariable id="customer" type="com.shop.model.Customer"--%>
...
<head>
    ...
    <title>Thông tin cá nhân - DPK Shop</title>
...
<main>
    <div class="profile-container">
        ...
        <div class="profile-header">
            ...
            <p>Xin chào, <strong>${sessionScope.customer.fullName}</strong>! Quản lý thông tin của bạn.</p>
        </div>
            ...
            <section class="card">
                ...
                <form action="${pageContext.request.contextPath}/profile" method="post">
                    ...
                    <div class="form-field">
                        ...
                        <small style="color: var(--text-light); font-size: 0.85rem; display: block; margin-top: 0.25rem;">
                            Ví dụ: 0901234567 (10 chữ số)
                        </small>
                    </div>
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="address"
                                  name="address"
                                  rows="3"
                                  style="width: 100%; padding: 0.875rem 1rem; border: 2px solid var(--border-color); border-radius: 8px; font-size: 1rem; font-family: inherit; resize: vertical;"
                                  placeholder="123 Đường ABC, Quận 1, TP.HCM">${sessionScope.customer.address}</textarea>
                    </div>
